                ...
                <div class="container">
                            ...
                            <div class="row text-center">
                                <div class="col-md-12 text-center">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th scope="col">CÓDIGO(S) EXEMPLAR(ES) DISPÓNIVEL(IS)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="row" items="${exemplaresSelecionados}">
                                                <tr>
                                                    <td>
                    ...
                    <div class="section">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <a class="btn btn-default" href="../index.jsp">Retornar ao Menu Empréstimo</a>
                                </div>
                            </div>
                        </div>
                    </div>
