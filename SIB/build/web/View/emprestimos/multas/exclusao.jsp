    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3 class="tt_menu">&gt;&gt; MULTAS - DAR BAIXA &lt;&lt;</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="http://localhost/SIB/ControladorEmprestimo" method="post">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="inputIdEmprestimo" class="control-label">Informar o Código da Multa (Empréstimo):</label>
                                </div>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="inputDataEfetiva" class="control-label">Informar Data da do Pagamento:</label>
                                </div>
                                <div class="col-sm-10">
                                    <input type="text" name="dataPagamento" class="form-control" minlength="10" id="inputDataPagamento" placeholder="Data de hoje" required>
                                </div>
                                <script>
                                    $("#inputDataPagamento").mask("00/00/0000");
                                </script>
                            </div>
                            <input type="hidden" name="idFormulario" value="6" />
                            <input type="hidden" name="tipoFormulario" value="65" />
                            <div class="col-md-12 text-center">
