    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="http://localhost/ProjetoWEB/View/util/autenticacao.jsp" method="post">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="inputEmail3" class="control-label">Informar o Usuário:</label>
                                </div>
                                <div class="col-sm-10">
                                    <input type="Number" name="idFuncionario" class="form-control" id="imputIdFuncionario" placeholder="Número de Usuário" title="Digite o seu número de usuário" required="">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
